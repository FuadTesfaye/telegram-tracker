    ...
    <div className="space-y-4">
      ...
      <div className="glass-card bg-[#111622]/80 border border-white/[0.07] rounded-2xl p-4 shadow-sm space-y-3">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="px-2.5 py-0.5 rounded-full bg-sky-500/10 text-sky-400 font-bold uppercase text-[10px] border border-sky-500/20">
            {user?.plan || "free"}
          </span>
        </div>
      </div>
      ...
      <div className="glass-card bg-[#111622]/80 border border-white/[0.07] rounded-2xl p-4 shadow-sm space-y-3">
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300 font-medium">Daily Evening Summary (21:00)</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300 font-medium">Weekly Progress Report (Mondays)</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300 font-medium">Long Session Alert (&gt; 60m)</span>
          <input
            type="checkbox"
        ...
        <button
          onClick={handleSave}
          className="w-full py-2.5 bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold rounded-xl transition-all tap-effect border border-sky-400/20"
        >
          Save Preferences
        </button>
      </div>
      ...
      {/* Privacy Guarantee */}
      <div className="glass-card bg-[#111622]/80 border border-white/[0.07] rounded-2xl p-4 shadow-sm space-y-2">
        <div className="flex items-center gap-2">
      ...
      <div className="text-center pt-2">
        ...
        >
          <HeartPulse className="w-3.5 h-3.5 text-sky-400" /> View System Health
        </Link>
      </div>
    </div>
  );
