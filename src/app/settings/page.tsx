    ...
    <div className="space-y-5">
      ...
      <div className="bg-slate-900/70 border border-slate-800/80 rounded-2xl p-4 shadow-sm space-y-3">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="px-2 py-0.5 rounded-full bg-blue-950 text-blue-400 font-bold uppercase text-[10px] border border-blue-800/60">
            {user?.plan || "free"}
          </span>
        </div>
      </div>
      ...
      <div className="bg-slate-900/70 border border-slate-800/80 rounded-2xl p-4 shadow-sm space-y-3">
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300">Daily Evening Summary (21:00)</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300">Weekly Progress Report (Mondays)</span>
          <input
            type="checkbox"
        ...
        <label className="flex items-center justify-between text-xs cursor-pointer">
          <span className="text-slate-300">Long Session Alert (&gt; 60m)</span>
          <input
            type="checkbox"
      ...
      {/* Privacy Guarantee */}
      <div className="bg-slate-900/70 border border-slate-800/80 rounded-2xl p-4 shadow-sm space-y-2">
        <div className="flex items-center gap-2">
      ...
      <div className="text-center pt-2">
        <Link
          href="/admin"
          className="text-xs text-slate-400 hover:text-slate-300 inline-flex items-center gap-1.5"
        >
          <HeartPulse className="w-3.5 h-3.5" /> View System Health
        </Link>
      </div>
    </div>
  );
